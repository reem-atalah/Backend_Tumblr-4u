...
/**
 * @api {put} user/:user_id/settings/privacy Update privacy settings
 * @apiName updateSettingsPrivacy
 * @apiGroup settings
 * @apiSampleRequest api.tumblr.com/user/:user_id/settings/privacy\-H "Authorization: Bearer < YOUR_API_TOKEN>"
...
/**
 * @api {put} user/:user_id/settings/notifications Update notifications settings
 * @apiName updateSettingsNotifications
 * @apiGroup settings
 * @apiSampleRequest api.tumblr.com/user/:user_id/settings/notifications\-H "Authorization: Bearer < YOUR_API_TOKEN>"
 * @apiPermission User, Admin, Super_Admin
 * 
...
/**
 * @api {put} user/:user_id/settings/dashboard Update dashboard settings
 * @apiName updateSettingsDashboard
 * @apiGroup settings
 * @apiSampleRequest api.tumblr.com/user/:user_id/settings/dashboard\-H "Authorization: Bearer < YOUR_API_TOKEN>"
 * @apiPermission User, Admin, Super_Admin
 * 
 * 
...
/**
 * @api {put} user/:user_id/settings/account Update account settings
 * @apiName updateSettingsAccount
 * @apiGroup settings
 * @apiSampleRequest api.tumblr.com/user/:user_id/settings/account\-H "Authorization: Bearer < YOUR_API_TOKEN>"
 * @apiPermission User, Admin, Super_Admin
 * 
