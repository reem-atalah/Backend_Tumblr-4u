 ...
 * @param {String} url  - URL of the blog and it should be unique
...
const createBlog = async (req, res) => {
  try {
    ...
    const anotherBlog= await schema.blogs.findOne({'url': url});
    ...
    if (!anotherBlog) {
      ...
      console.log(352);
      const blog= await schema.blogs.findOne({'url': url});
